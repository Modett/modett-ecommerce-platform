...
export class AddPOItemCommandHandler
  implements ICommandHandler<AddPOItemCommand, CommandResult<PurchaseOrderItem>>
{
...
export { AddPOItemCommandHandler as AddPOItemHandler };
