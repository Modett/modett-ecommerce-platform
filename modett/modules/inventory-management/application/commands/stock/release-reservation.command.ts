...
export class ReleaseReservationCommandHandler
  implements ICommandHandler<ReleaseReservationCommand, CommandResult<Stock>>
{
  ...
  async handle(
    ...
    try {
      ...
      // Execute service
      const stock = await this.stockService.releaseReservation(
        command.variantId,
        command.locationId,
        command.quantity,
...
export { ReleaseReservationCommandHandler as ReleaseReservationHandler };
