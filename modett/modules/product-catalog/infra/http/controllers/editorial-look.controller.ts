...
export class EditorialLookController {
  ...
  async getEditorialLooks(request: FastifyRequest<{ Querystring: EditorialLookQueryParams }>, reply: FastifyReply) {
    try {
      const {
        page = 1,
        limit = 20,
  ...
  async getEditorialLook(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      ...
      const look = await this.editorialLookManagementService.getEditorialLookById(id);
  ...
  async createEditorialLook(request: FastifyRequest<{ Body: CreateEditorialLookRequest }>, reply: FastifyReply) {
    try {
      const lookData = request.body;

      // Basic validation
      if (!lookData.title || typeof lookData.title !== 'string' || lookData.title.trim().length === 0) {
        return reply.code(400).send({
          success: false,
          error: 'Bad Request',
      ...
      if (lookData.publishedAt) {
        ...
        if (publishedAt <= new Date()) {
          return reply.code(400).send({
            success: false,
            error: 'Bad Request',
            message: 'Publication date must be in the future for scheduled publication'
          });
        }
      }
  ...
  async updateEditorialLook(request: FastifyRequest<{ Params: { id: string }; Body: UpdateEditorialLookRequest }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      if (updateData.storyHtml !== undefined && updateData.storyHtml && updateData.storyHtml.length > 100000) {
        return reply.code(400).send({
          success: false,
          error: 'Bad Request',
          message: 'Story content cannot exceed 100,000 characters'
      ...
      const look = await this.editorialLookManagementService.updateEditorialLook(id, updates);
  ...
  async deleteEditorialLook(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
  ...
  async publishEditorialLook(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
  ...
  async unpublishEditorialLook(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
  ...
  async schedulePublication(request: FastifyRequest<{ Params: { id: string }; Body: SchedulePublicationRequest }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      if (!publishDate || typeof publishDate !== 'string') {
        return reply.code(400).send({
          success: false,
          error: 'Bad Request',
          message: 'Publish date is required and must be a valid ISO date string'
        });
      }
      ...
      const look = await this.editorialLookManagementService.scheduleLookPublication(id, publishDateTime);
      ...
      if (error instanceof Error && error.message.includes('cannot be scheduled')) {
        return reply.code(400).send({
          success: false,
          error: 'Bad Request',
          message: error.message
  ...
  async setHeroImage(request: FastifyRequest<{ Params: { id: string }; Body: SetHeroImageRequest }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const look = await this.editorialLookManagementService.setHeroImage(id, assetId);
      ...
      if (error instanceof Error && error.message.includes('must be an image')) {
        return reply.code(400).send({
          success: false,
          error: 'Bad Request',
          message: error.message
  ...
  async removeHeroImage(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const look = await this.editorialLookManagementService.removeHeroImage(id);
  ...
  async getLooksByHeroAsset(request: FastifyRequest<{ Params: { assetId: string } }>, reply: FastifyReply) {
    try {
      ...
      const looks = await this.editorialLookManagementService.getLooksByHeroAsset(assetId);
  ...
  async addProductToLook(request: FastifyRequest<{ Params: { id: string; productId: string } }>, reply: FastifyReply) {
    try {
  ...
  async removeProductFromLook(request: FastifyRequest<{ Params: { id: string; productId: string } }>, reply: FastifyReply) {
    try {
      const { id, productId } = request.params;
      ...
      await this.editorialLookManagementService.removeProductFromLook(id, productId);
  ...
  async setLookProducts(request: FastifyRequest<{ Params: { id: string }; Body: SetLookProductsRequest }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const look = await this.editorialLookManagementService.setLookProducts(id, productIds);
  ...
  async getLookProducts(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const productIds = await this.editorialLookManagementService.getLookProducts(id);
  ...
  async getProductLooks(request: FastifyRequest<{ Params: { productId: string } }>, reply: FastifyReply) {
    try {
      ...
      const lookIds = await this.editorialLookManagementService.getProductLooks(productId);
  ...
  async getLooksByProduct(request: FastifyRequest<{ Params: { productId: string }; Querystring: EditorialLookQueryParams }>, reply: FastifyReply) {
    try {
      const { productId } = request.params;
  ...
  async updateStoryContent(request: FastifyRequest<{ Params: { id: string }; Body: UpdateStoryContentRequest }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const look = await this.editorialLookManagementService.updateStoryContent(id, storyHtml);
  ...
  async clearStoryContent(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const look = await this.editorialLookManagementService.clearStoryContent(id);
  ...
  async getPopularProducts(request: FastifyRequest<{ Querystring: { limit?: number } }>, reply: FastifyReply) {
    try {
  ...
  async createBulkEditorialLooks(request: FastifyRequest<{ Body: BulkCreateEditorialLooksRequest }>, reply: FastifyReply) {
    try {
  ...
  async deleteBulkEditorialLooks(request: FastifyRequest<{ Body: BulkDeleteEditorialLooksRequest }>, reply: FastifyReply) {
    try {
      ...
      const result = await this.editorialLookManagementService.deleteMultipleEditorialLooks(ids);
  ...
  async publishBulkEditorialLooks(request: FastifyRequest<{ Body: BulkPublishEditorialLooksRequest }>, reply: FastifyReply) {
    try {
      const { ids } = request.body;
      ...
      const result = await this.editorialLookManagementService.publishMultipleLooks(ids);
  ...
  async validateForPublication(request: FastifyRequest<{ Params: { id: string } }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const validation = await this.editorialLookManagementService.validateLookForPublication(id);
  ...
  async duplicateEditorialLook(request: FastifyRequest<{ Params: { id: string }; Body: DuplicateEditorialLookRequest }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
      ...
      const duplicatedLook = await this.editorialLookManagementService.duplicateEditorialLook(id, newTitle);
