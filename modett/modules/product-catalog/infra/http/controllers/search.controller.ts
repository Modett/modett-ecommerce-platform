...
export class SearchController {
  ...
  async searchProducts(request: FastifyRequest<{ Querystring: SearchQueryParams }>, reply: FastifyReply) {
    try {
      const {
        q,
        page = 1,
  ...
  async getSearchSuggestions(request: FastifyRequest<{ Querystring: SearchSuggestionsQueryParams }>, reply: FastifyReply) {
    try {
      const {
        q,
        limit = 10,
  ...
  async getSearchFilters(request: FastifyRequest<{ Querystring: { q?: string; category?: string } }>, reply: FastifyReply) {
    try {
