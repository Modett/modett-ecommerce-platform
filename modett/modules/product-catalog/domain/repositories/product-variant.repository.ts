...
export interface IProductVariantRepository {
  ...
  findByPriceRange(min: number, max: number, options?: VariantQueryOptions): Promise<ProductVariant[]>;
  findBySize(size: string, options?: VariantQueryOptions): Promise<ProductVariant[]>;
  findByColor(color: string, options?: VariantQueryOptions): Promise<ProductVariant[]>;
...
export interface VariantQueryOptions {
  limit?: number;
  offset?: number;
  sortBy?: 'sku' | 'price' | 'createdAt' | 'updatedAt';
  sortOrder?: 'asc' | 'desc';
