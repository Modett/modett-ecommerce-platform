...
export interface IMediaAssetRepository {
  ...
  findByMimeType(mimeType: string, options?: MediaAssetQueryOptions): Promise<MediaAsset[]>;
  findImages(options?: MediaAssetQueryOptions): Promise<MediaAsset[]>;
  findVideos(options?: MediaAssetQueryOptions): Promise<MediaAsset[]>;
  findByDimensions(width: number, height: number, options?: MediaAssetQueryOptions): Promise<MediaAsset[]>;
  findBySizeRange(minBytes: number, maxBytes: number, options?: MediaAssetQueryOptions): Promise<MediaAsset[]>;
