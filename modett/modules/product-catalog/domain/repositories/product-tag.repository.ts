...
export interface IProductTagRepository {
  ...
  findByKind(kind: string, options?: ProductTagQueryOptions): Promise<ProductTag[]>;
  findByProductId(productId: string): Promise<ProductTag[]>;
  search(query: string, options?: ProductTagQueryOptions): Promise<ProductTag[]>;
  getMostUsed(limit?: number): Promise<Array<{ tag: ProductTag; count: number }>>;
