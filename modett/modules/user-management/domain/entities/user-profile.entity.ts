import { UserId } from '../value-objects/user-id.vo';
  ...
  export class UserProfile {
    ...
    getDefaultAddressId(): string | null { return this.defaultAddressId; }
    getDefaultPaymentMethodId(): string | null { return this.defaultPaymentMethodId; }
    getPreferences(): UserPreferences { return { ...this.preferences }; }
    getLocale(): string | null { return this.locale; }
    getCurrency(): string | null { return this.currency; }
    getStylePreferences(): StylePreferences { return { ...this.stylePreferences }; }
    getPreferredSizes(): PreferredSizes { return { ...this.preferredSizes }; }      
    ...
    setCurrency(currency: string): void {
      if (!currency || !this.isValidCurrency(currency)) {
        throw new Error('Invalid currency code. Use ISO 4217 format like "USD", "EUR"');
      }
    ...
    getPreferredSize(category: string): string | null {
      return this.preferredSizes[category] || null;
    }
  ...
  export interface PreferredSizes {
    ...
    pantsSizeSystem?: 'US' | 'EU' | 'UK';
    shoesSizeSystem?: 'US' | 'EU' | 'UK';
  }