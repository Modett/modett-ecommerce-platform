...
export interface IAddressRepository {
  ...
  findByCountry(country: string, limit?: number, offset?: number): Promise<Address[]>;
  ...
  findConflictingAddress(userId: UserId, address: Address): Promise<Address | null>;
  findSimilarAddresses(address: Address, threshold?: number): Promise<Address[]>;

  // Analytics operations
  getAddressStatsByCountry(): Promise<Array<{
    country: string;
    count: number;
  }>>;
