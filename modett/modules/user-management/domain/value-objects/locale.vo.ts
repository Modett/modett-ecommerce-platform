export class Locale {
  ...
  constructor(locale: string) {
    ...
    if (!this.isValidLocale(normalizedLocale)) {
      throw new Error(`Invalid locale format: ${locale}. Use format like "en-US", "fr-FR", "de-DE"`);
    }
  ...
  getDefaultCurrency(): string {
    const localeCurrencyMap: Record<string, string> = {
      ...
      "en-IE": "EUR", "en-ZA": "ZAR", "en-IN": "INR", "en-SG": "SGD",
      "fr-FR": "EUR", "fr-CA": "CAD", "fr-BE": "EUR", "fr-CH": "CHF",
      ...
      "pl-PL": "PLN", "cs-CZ": "CZK", "hu-HU": "HUF", "ru-RU": "RUB", "tr-TR": "TRY",
      "zh-CN": "CNY", "zh-TW": "TWD", "zh-HK": "HKD",
      "ja-JP": "JPY", "ko-KR": "KRW", "th-TH": "THB", "vi-VN": "VND", "hi-IN": "INR",
      "ar-SA": "SAR", "ar-AE": "AED", "ar-EG": "EGP", "he-IL": "ILS",
      "id-ID": "IDR", "ms-MY": "MYR", "tl-PH": "PHP",
    };
  ...
  static getAllSupportedLocales(): string[] {
    return [
      ...
      "zh-CN", "zh-TW", "zh-HK",
      "ja-JP", "ko-KR", "th-TH", "vi-VN", "hi-IN",
      "ar-SA", "ar-AE", "ar-EG", "he-IL",
      "id-ID", "ms-MY", "tl-PH"
    ];
  }
