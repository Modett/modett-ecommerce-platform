...
export interface ProcessPaymentRequest { intentId: string; pspReference?: string }
export interface RefundPaymentRequest { intentId: string; amount?: number; reason?: string }
export interface VoidPaymentRequest { intentId: string; pspReference?: string }
