...
export interface IOrderStatusHistoryRepository {
  ...
  findByOrderId(orderId: string, options?: StatusHistoryQueryOptions): Promise<OrderStatusHistory[]>;
  findByStatus(status: OrderStatus, options?: StatusHistoryQueryOptions): Promise<OrderStatusHistory[]>;
  findByChangedBy(changedBy: string, options?: StatusHistoryQueryOptions): Promise<OrderStatusHistory[]>;
